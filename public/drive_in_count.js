    ...
    function createRow() {
        ...
        return (
            <tr id={"row" + totalRows.current}>
                ...
                <td><input name={"petcolor" + totalRows.current} id={"petcolor" + totalRows.current} onChange={onInputChange} minimum="0" maximum="100" step="1" value={petColorArray[totalRows.current - 1]}></input></td>
