    ...
    function createRow() {
        ...
        return (
            <tr id={"row" + totalRows.current}>
                <td><input pattern="\d+" name={"glass" + totalRows.current} id={"glass" + totalRows.current} type="number" onChange={onInputChange} min="0" max="100" step="1" value={glassArray[totalRows.current - 1]}></input></td>
                ...
                <td><input pattern="\d+" name={"aluminium" + totalRows.current} id={"aluminium" + totalRows.current} type="number" onChange={onInputChange} minimum="0" maximum="100" step="1" value={aluminiumArray[totalRows.current - 1]}></input></td>
                <td><input pattern="\d+" name={"petclear" + totalRows.current} id={"petclear" + totalRows.current} type="number" onChange={onInputChange} minimum="0" maximum="100" step="1" value={petClearArray[totalRows.current - 1]}></input></td>
                <td><input pattern="\d+" name={"petcolor" + totalRows.current} id={"petcolor" + totalRows.current} type="number" onChange={onInputChange} minimum="0" maximum="100" step="1" value={petColorArray[totalRows.current - 1]}></input></td>
                <td><input pattern="\d+" name={"hdpe" + totalRows.current} id={"hdpe" + totalRows.current} type="number" onChange={onInputChange} minimum="0" maximum="100" step="1" value={hdpeArray[totalRows.current - 1]}></input></td>
                <td><input pattern="\d+" name={"lpb" + totalRows.current} id={"lpb" + totalRows.current} type="number" onChange={onInputChange} minimum="0" maximum="100" step="1" value={lpbArray[totalRows.current - 1]}></input></td>
                <td><input pattern="\d+" name={"steel" + totalRows.current} id={"steel" + totalRows.current} type="number" onChange={onInputChange} minimum="0" maximum="100" step="1" value={steelArray[totalRows.current - 1]}></input></td>
                <td><input pattern="\d+" name={"other" + totalRows.current} id={"other" + totalRows.current} type="number" onChange={onInputChange} minimum="0" maximum="100" step="1" value={otherArray[totalRows.current - 1]}></input></td>
            </tr>
        )
    }
